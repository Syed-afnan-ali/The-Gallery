  ...
  "Atacama Desert",
    ...
    return (
        <>
            <Sidebar />
            <SearchBar
                placeholder="Search Desert & nature..."
                onSearch={(q) => {
                    setCategory(q);
                    setPage(1);
            ...
            <div className="w-full  min-h-screen bg-gray-50 -mt-10 pl-25 pr-15 ">
                ...
                {/* ✅ Reusable SearchBar */}
                {/* Heading */}
                <h1 className="text-5xl font-bold pt-10  text-gray-800">
                  Desert Gallery
                </h1>
                <p className="pb-8 text-gray-600">
                    Find your perfect Desert image. Free pictures to download and use in
                    your next project.
                </p>
