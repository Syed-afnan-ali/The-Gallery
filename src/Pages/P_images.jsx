...
const P_images = () => {
    ...
    const [category, setCategory] = useState("Popular images");
        ...
        const fetchCarouselImages = async () => {
            try {
                const res = await fetch(
                    `https://pixabay.com/api/?key=${API_KEY}&q=P_images&image_type=photo&per_page=25`
                );
                const data = await res.json();
  ...
  "Flowers",
    ...
    return (
        <>
            <Sidebar />
            <SearchBar
                placeholder="Search Popular Images & nature..."
                onSearch={(q) => {
                    setCategory(q);
                    setPage(1);
            ...
            <div className="w-full min-h-screen bg-gray-50 -mt-10 pl-25 pr-10">
                ...
                <h1 className="text-6xl text-center pt-15 font-bold text-gray-800">
                    Popular images Gallery
                </h1>
                <p className="pb-8 text-lg text-center mb-5 text-gray-600">
                    Find your perfect Popular image. Free pictures to download and use in
                    your next project.
                </p>
