        ...
        const fetchCarouselImages = async () => {
            try {
                const res = await fetch(
                    `https://pixabay.com/api/?key=${API_KEY}&q=Coffee&image_type=photo&per_page=25`
                );
                const data = await res.json();
  ...
  "Ristretto",
    ...
    return (
        <>
            <Sidebar />
            <SearchBar
                placeholder="Search Coffee & nature..."
                onSearch={(q) => {
                    setCategory(q);
                    setPage(1);
            ...
            <div className="w-full min-h-screen bg-gray-50 -mt-10 pl-25 pr-10">
                ...
                <p className="pb-8 text-lg text-center mb-5 text-gray-600">
                    Find your perfect Coffee image. Free pictures to download and use in
                    your next project.
                </p>
